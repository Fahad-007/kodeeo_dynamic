...
if(isset($_POST['btnSave'])){
    ...
    if(empty($memberName)){
        ...
        if(in_array($imgExt, $allowExt)){
            ...
            if($imgSize < 5000000){
                move_uploaded_file($imgTmp ,$upload_dir.$memberImg);
            }else{
    ...
    if(!isset($err_msg)){
        $query = "insert into team_members (member_img, member_name, designation)
					values('".$memberImg."', '".$memberName."', '".$designation."')";
...
<div class="navbar navbar-default">
    <div class="container">
        <div class="navbar-header">
            <h3 class="navbar-brand">Add New Member</h3>
        </div>
    </div>
</div>
<div class="container">
    <div class="page-header">
        <h3>
            <a class="btn btn-default" href="team_members.php">
