        ...
        <div class="content-wrapper content-wrapper--with-bg">
            ...
            <div id="ex3" class="page-content">
                ...
                <div class="page-header">
                    <h3>
                        <a class="btn btn-default" href="about_add.php">
            ...
            ?>
                <tr>
                    ...
                    <td class="col-md-4"><?php echo $row['paragraph'] ?></td>
                    <td><?php echo $row['btn_text'] ?></td>
                    <td><?php echo $row['bg_color']; ?></td>
                    <td><?php echo $row['icon_bg']; ?></td>
                    <td>
                        <span>
                            <a class="btn btn-info" href="about_edit.php?id=<?php echo $row['id'] ?>">Edit</a>
                            <a class="btn btn-danger" href="about.php?delete=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure to delete this record?')">Delete</a>
                        </span>
                    </td>
                </tr>
            <?php
