<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        $query = "select slider_img from slider_section where id = ".$id;
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $query = "delete from slider_section where id=".$id;
...
<body>
            ...
            <div class="l-sidebar__content">
                ...
                <nav class="c-menu js-menu">
                    <ul class="u-list">
                        ...
                        <li class="c-menu__item has-submenu is-active" data-toggle="tooltip" title="Slider">
                            <a href="slider.php">
    ...
    <main class="l-main" style="top: 70px;position: absolute;">
        <div class="content-wrapper content-wrapper--with-bg">
            <h1 class="page-title">Slider Section</h1>
            <div id="ex3" class="page-content">

                <div class="page-header">
                    <h3>
                        <a class="btn btn-default btn-cstm" href="slider_add.php">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="width: 200px;height: 150px;"><img src="<?php echo $upload_dir.$row['slider_img'] ?>" height="40" style="width: 100%;height: 100%"></td>
                            <td><?php echo $row['slider_heading'] ?></td>
                            <td class="col-md-6"><?php echo $row['slider_paragraph'] ?></td>
                            <td>
                                <span>
                                    <a class="btn btn-info" href="slider_edit.php?id=<?php echo $row['id'] ?>">
                                        <span class="glyphicon glyphicon-edit"></span>Edit
                                    </a>
                                    <a class="btn btn-danger" href="slider.php?delete=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure to delete this record?')">
